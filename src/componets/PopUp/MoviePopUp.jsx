              ...
              <Fade bottom duration={500}>
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-neutral-800 outline-none focus:outline-none">
                  ...
                  <div className="flex ml-4 items-center -mt-14">
                    <button
                      className="flex items-center justify-center bg-gradient-to-r from-flodrama-blue to-flodrama-fuchsia text-white active:bg-gradient-to-r from-flodrama-blue to-flodrama-fuchsia font-medium sm:font-bold uppercase text-xs px-4 sm:px-6 md:text-sm  py-2 rounded shadow hover:shadow-lg cursor-pointer outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                      type="button"
                      onClick={() => {
                        setShowModal(false);
                        playMovie(PopupInfo);
                  ...
                  <div className="sm:flex items-center justify-end p-2 rounded-b">
                    ...
                    <div className="flex justify-between p-2">
                      ...
                      <button
                        className="flex items-center text-flodrama-fuchsia background-transparent font-medium sm:font-bold uppercase px-2 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        onClick={() => setShowModal(false)}
                      >
                        <svg
