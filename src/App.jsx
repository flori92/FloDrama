...
function App() {
  ...
  useEffect(() => {
    try {
      // Initialiser le service d'images unifié
      unifiedImageService.initialize().then(() => {
        console.log('Service d\'images unifié initialisé');
      }).catch(err => {
        console.warn('Erreur lors de l\'initialisation du service d\'images:', err);
      });
    } catch (err) {
      console.warn('Erreur lors de l\'initialisation des services:', err);
    }
  }, []);
