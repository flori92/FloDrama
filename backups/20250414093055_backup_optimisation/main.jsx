...
function initializeUtilities() {
  ...
  try {
    ...
    if (cacheSize > 100) {
      ...
      // Nettoyer le cache en supprimant les entrées les plus anciennes
      // Cela sera géré automatiquement par cacheManager lors de son utilisation
    }
  } catch (error) {
...
function preloadImportantImages() {
  try {
    ...
    importantImages.forEach(imageUrl => {
      localImageFallback.preloadAndCacheImage(imageUrl)
