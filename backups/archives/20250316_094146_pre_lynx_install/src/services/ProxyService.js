...
class ProxyService {
  constructor() {
    ...
    console.log(`[ProxyService] Initialisé en mode ${this.isDevelopment ? 'développement' : 'production'}`);
  }
    ...
    try {
      ...
      while (attempts < this.maxRetries) {
        try {
          ...
          lastError = error;
          console.warn(`[ProxyService] Tentative ${attempts}/${this.maxRetries} échouée:`, error);
