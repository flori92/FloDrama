    ...
    >
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Colonne 1 - À propos */}
          <div>
            <h3 className="text-sm font-medium mb-4 hover:text-transparent hover:bg-gradient-to-r from-blue-400 to-fuchsia-500 bg-clip-text transition-colors duration-200">
              FloDrama
            </h3>
            <ul className="space-y-2">
              <motion.li
                className="text-xs text-white/60 hover:text-transparent hover:bg-gradient-to-r from-blue-400 to-fuchsia-500 bg-clip-text transition-colors duration-200 cursor-pointer"
                whileHover={{ x: 2 }}
              >
                À propos
              </motion.li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          ...
          {showLanguageSelector && (
            <div className="mb-4 md:mb-0">
              <select className="bg-transparent border border-white/20 rounded-md text-xs text-white/60 py-1 px-2 focus:outline-none focus:ring-1 focus:ring-white/40">
          ...
          <div className="text-xs text-white/40">
            © {currentYear} FloDrama. Tous droits réservés.
          </div>
        </div>
      </div>
    </HybridComponent>
