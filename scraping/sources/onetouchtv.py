...
# -*- coding: utf-8 -*-
"""
Script de scraping OneTouchTV pour FloDrama
Ce script extrait les dramas depuis OneTouchTV et les enregistre dans Supabase.
"""
...
logger = logging.getLogger('onetouchtv_scraper')
...
def scrape_and_upload_dramas():
    logger.info(f"Début du scraping OneTouchTV")
    session_id = supabase_db.log_scraping_start('onetouchtv', 'dramas')
