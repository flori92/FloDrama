/**
 * Script de test local pour le service de paiement FloDrama
 * 
 * Ce script teste les fonctionnalités du service de paiement en local
...
const config = {
  baseUrl: 'http://localhost:54112', // URL du serveur local
  endpoints: {
...
async function runAllTests() {
  ...
  console.log(`${COLORS.fg.blue}║                                                               ║${COLORS.reset}`);
  console.log(`${COLORS.fg.blue}╚═══════════════════════════════════════════════════════════════╝${COLORS.reset}`);
  console.log(`${COLORS.fg.blue}                 Tests du Service de Paiement                    ${COLORS.reset}`);
  console.log('');
  ...
  try {
    ...
    logSection('0. VÉRIFICATION DE SANTÉ DU SERVEUR');
    await testEndpoint('get', config.endpoints.health, null, false);
