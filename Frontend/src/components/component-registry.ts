...
const defaultFallbacks = {
  heroBanner: <div className="h-[85vh] w-full bg-gradient-to-r from-blue-500/20 to-fuchsia-500/20 animate-pulse rounded-lg" />,
  contentRow: <div className="h-64 w-full bg-gradient-to-r from-blue-500/10 to-fuchsia-500/10 animate-pulse rounded-lg my-8" />,
  contentCard: <div className="w-[200px] h-[300px] bg-white/5 animate-pulse rounded-md" />,
  featuredSection: <div className="h-96 w-full bg-gradient-to-r from-blue-500/10 to-fuchsia-500/10 animate-pulse rounded-lg my-8" />,
  header: <div className="h-16 w-full bg-black/80 animate-pulse" />,
  footer: <div className="h-64 w-full bg-black animate-pulse mt-8" />
};
 ...
 */
export const getDynamicComponent = (name: string, props: any = {}): React.ReactNode => {
